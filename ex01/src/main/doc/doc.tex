...
The input image can be seen in
fig. \ref{fig:\imgRoot/input.jpg},
while the output image can be seen in
fig. \ref{fig:\imgGeneratedRoot/result.jpg}.

\image{\imgRoot/input.jpg}{0.8}{%
		input image}
\image{\imgGeneratedRoot/result.jpg}{0.8}{%
		output image}
